...
Public Class repNotaCobranzaLluvia
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repNotaCobranzaLluvia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepNotaCobranzaLluvia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repNotaCobranzaLluvia = New repNotaCobranzaLluvia
        rpt.Site = Me.Site
        Return rpt
    End Function
