...
Public Class repCartaCobranzaLightLluvia2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repCartaCobranzaLightLluvia2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCartaCobranzaLightLluvia2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCartaCobranzaLightLluvia2 = New repCartaCobranzaLightLluvia2
        rpt.Site = Me.Site
        Return rpt
    End Function
