...
Public Class repCartaCobranzaLluvia
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "repCartaCobranzaLluvia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCartaCobranzaLluvia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCartaCobranzaLluvia = New repCartaCobranzaLluvia
        rpt.Site = Me.Site
        Return rpt
    End Function
