...
Public Class RepListadoCuotasPorVencer
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RepListadoCuotasPorVencer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepListadoCuotasPorVencer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepListadoCuotasPorVencer = New RepListadoCuotasPorVencer
        rpt.Site = Me.Site
        Return rpt
    End Function
