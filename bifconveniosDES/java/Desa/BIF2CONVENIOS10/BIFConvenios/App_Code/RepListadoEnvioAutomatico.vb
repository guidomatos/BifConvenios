...
Public Class RepListadoEnvioAutomatico
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RepListadoEnvioAutomatico.rpt"
        End Get
...
Public Class CachedrepAutomatico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepListadoEnvioAutomatico = New RepListadoEnvioAutomatico
        rpt.Site = Me.Site
        Return rpt
    End Function
