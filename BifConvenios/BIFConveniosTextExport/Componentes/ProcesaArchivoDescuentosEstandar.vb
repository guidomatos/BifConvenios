...
'Procesa la carga del archivo de descuentos estandar
Class ProcesaArchivoDescuentosEstandar
    '****************************************************************
    'Microsoft SQL Server 2000
    'Visual Basic file generated for DTS Package
    'File Name: c:\BIFConvenios - Proceso Carga Archivo Descuentos.bas
    'Package Name: BIFConvenios - Proceso Carga Archivo Descuentos
    'Package Description:
    'Generated Date: 12/02/2004
    'Generated Time: 11:52:24 a.m.
    '****************************************************************
    ...
    Public Sub ExecuteProcesoArchivoDescuentosEstandard(ByRef ruta As String, ByVal idProceso As String)
        ...
        goPackage.Name = "BIFConvenios - Proceso Carga Archivo Descuentos - V3"
        ...
        oConnection.ConnectionProperties.Item("Data Source").Value = mruta '"C:\Documents and Settings\Administrator\Desktop\DIRELAD-1.csv"
        ...
        oConnection.ConnectionProperties.Item("Skip Rows").Value = 1
        ...
        oConnection.Reusable = True
        oConnection.ConnectImmediate = False
        oConnection.DataSource = mruta ' "C:\Documents and Settings\Administrator\Desktop\DIRELAD-1.csv"
        oConnection.ConnectionTimeout = 60
        oConnection.UseTrustedConnection = False
        oConnection.UseDSL = False
        ...
        '---------------------------------------------------------------------------
        frmMonitor.Add2LogMessage("Preparando la ejecución")
...
PackageError:
    ...
    Private Sub Task_Sub1(ByVal goPackage As Object)
        ...
        oCustomTask1.SourceObjectName = mruta '"C:\Documents and Settings\Administrator\Desktop\DIRELAD-2.TXT"
    ...
    Private Sub oCustomTask1_Trans_Sub1(ByVal oCustomTask1 As Object)
        ...
        '        oColumn = oTransformation.SourceColumns.New("CodigoBanco", 1)
    ...
    Private Sub oCustomTask1_Trans_Sub2(ByVal oCustomTask1 As Object)
        ...
        oColumn.Name = "Col002"
        '        oColumn = oTransformation.SourceColumns.New("Moneda", 1)
        '       oColumn.Name = "Moneda"
        oColumn.Ordinal = 1
        oColumn.Flags = 32
        oColumn.Size = 255
    ...
    Private Sub oCustomTask1_Trans_Sub3(ByVal oCustomTask1 As Object)
        ...
        oColumn.Name = "Col003"
        '        oColumn = oTransformation.SourceColumns.New("NumeroPagare", 1)
    ...
    Private Sub oCustomTask1_Trans_Sub4(ByVal oCustomTask1 As Object)
        ...
        '        oColumn = oTransformation.SourceColumns.New("CodigoModular", 1)
    ...
    Private Sub oCustomTask1_Trans_Sub5(ByVal oCustomTask1 As Object)
        ...
        '        oColumn = oTransformation.SourceColumns.New("NombreTrabajador", 1)
    ...
    Private Sub oCustomTask1_Trans_Sub6(ByVal oCustomTask1 As Object)
        ...
        '        oColumn = oTransformation.SourceColumns.New("CodigoReferencia", 1)
    ...
    Private Sub oCustomTask1_Trans_Sub7(ByVal oCustomTask1 As Object)
        ...
        '        oColumn = oTransformation.SourceColumns.New("Anio", 1)
        '       oColumn.Name = "Anio"
    ...
    Private Sub oCustomTask1_Trans_Sub8(ByVal oCustomTask1 As Object)
        ...
        oColumn.Name = "Col008"
        '        oColumn = oTransformation.SourceColumns.New("Mes", 1)
        '       oColumn.Name = "Mes"
        oColumn.Ordinal = 1
        oColumn.Flags = 32
        oColumn.Size = 255
    ...
    Private Sub oCustomTask1_Trans_Sub9(ByVal oCustomTask1 As Object)
        ...
        '        oColumn = oTransformation.SourceColumns.New("Cuota", 1)
        '        oColumn.Name = "Cuota"
    ...
    Private Sub oCustomTask1_Trans_Sub10(ByVal oCustomTask1 As Object)
        ...
        '        oColumn = oTransformation.SourceColumns.New("SituacionLaboral", 1)
    ...
    Private Sub oCustomTask1_Trans_Sub11(ByVal oCustomTask1 As Object)
        ...
        '        oColumn = oTransformation.SourceColumns.New("MontoDescuento", 1)
