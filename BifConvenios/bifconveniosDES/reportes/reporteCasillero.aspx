...
<%@ Register TagPrefix="uc2" TagName="pnlBusEmpresa" Src="~/controls/BuscarEmpresa.ascx" %>
    		                        ...
    		                        <table class="InputField" cellSpacing="0" cellPadding="5" width="100%" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <uc2:pnlBusEmpresa id="ucBuscarEmpresa" runat="server"></uc2:pnlBusEmpresa>
											    <input id="hdCodigoEmpresa" type="hidden" name="hdCodigoEmpresa" runat="server"/>
											</td>											
											<td align="right">
											    <asp:ImageButton id="lnkBuscar" runat="server" ImageUrl="~/images/procesar.jpg" OnClientClick="validar();"></asp:ImageButton>&nbsp;
											</td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" align="right">
                                                <asp:ImageButton id="lnkBack" runat="server" ImageUrl="~/images/regresar.jpg"></asp:ImageButton>&nbsp;
                                            </td>
                                        </tr>
	    	                        </table>				                    				                 
				                 </td>				            
