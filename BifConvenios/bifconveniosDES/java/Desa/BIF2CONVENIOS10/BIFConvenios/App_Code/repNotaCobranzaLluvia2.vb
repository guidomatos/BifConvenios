...
Public Class repNotaCobranzaLluvia2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repNotaCobranzaLluvia2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepNotaCobranzaLluvia2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repNotaCobranzaLluvia2 = New repNotaCobranzaLluvia2
        rpt.Site = Me.Site
        Return rpt
    End Function
