...
Public Class repCartaCobranzaLightLluvia
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repCartaCobranzaLightLluvia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCartaCobranzaLightLluvia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCartaCobranzaLightLluvia = New repCartaCobranzaLightLluvia
        rpt.Site = Me.Site
        Return rpt
    End Function
