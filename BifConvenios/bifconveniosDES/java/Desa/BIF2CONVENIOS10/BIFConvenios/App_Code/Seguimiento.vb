...
Namespace BIFConvenios
    Public Class Seguimiento
        ...
        Public Shared Function GetDocumentoPagosPendientesMontosPendientes(ByVal numerosPagare As String, _
            ...
            Dim connection As New OleDbConnection(Utils.DescifrarCadenaConexion(ConfigurationSettings.AppSettings("AS400-ConnectionString-Convenios")))
...
#Region "Reportes"
        ...
        Public Shared Function getDatosDevolucion(ByVal Cliente As String, ByVal NumeroPagare As String, ByVal mAnio As String, _
            ...
            str = "SELECT DLIDV FROM(" & vbCrLf
            str = str & " SELECT DLIDV FROM DLREC WHERE DLRCC =" & Cliente & " AND DLRNP= '" & NumeroPagare & "' AND " & vbCrLf
            str = str & " DLRAP = " & mAnio & " And DLRMP = " & mMes & " And DLEDV = 'P' " & vbCrLf
            str = str & " UNION ALL " & vbCrLf
            str = str & " SELECT DLIDV FROM DLRECH WHERE DLRCC = " & Cliente & " AND DLRNP= '" & NumeroPagare & "' AND " & vbCrLf
