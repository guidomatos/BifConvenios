...
Public Class repCartaCobranzaLight
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repCartaCobranzaLight.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCartaCobranzaLight
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCartaCobranzaLight = New repCartaCobranzaLight
        rpt.Site = Me.Site
        Return rpt
    End Function
