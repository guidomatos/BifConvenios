...
Namespace BIFConvenios
    ...
    Partial Class EditarCoordinadorCliente
        Inherits System.Web.UI.Page

        Private oCliente As New Cliente()

        Protected objCoordinadorCliente As New clsCoordinadorCliente()
        Protected objCliente As New clsCliente()

        Protected objCoordinadorClienteBL As New clsCoordinadorClienteBL()
...
#Region "Metodos"
        ...
        Private Sub BindDG()
            Try
                dtCoordinadores = objCoordinadorClienteBL.ObtieneCoordinadorPorCriterio(0, intCodCliente, 1)
        ...
        Private Sub HabilitarEdicion()
            ...
            Try
                ...
                dt = objCoordinadorClienteBL.ObtieneCoordinadorPorCriterio(Convert.ToInt32(hdCodCoordinador.Value), Convert.ToInt32(hdCodCliente.Value), -1)
            ...
            Try
                ...
                If strMensaje = "" Or Len(strMensaje) = 0 Then
                    ...
                    If hdTipoGuardar.Value = 1 Then
                        ...
                        objCoordinadorClienteBL.Insert(objCoordinadorCliente)
                    ...
                    ElseIf hdTipoGuardar.Value = 2 Then
                        ...
                        objCoordinadorClienteBL.Update(objCoordinadorCliente)
...
#End Region
        ...
        Protected Sub lnkEliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkEliminar.Click
            ...
            Try
                ...
                objCoordinadorClienteBL.ChangeStatus(objCoordinadorCliente)
