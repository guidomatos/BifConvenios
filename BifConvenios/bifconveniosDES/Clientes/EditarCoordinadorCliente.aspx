<%@ Page Language="vb" AutoEventWireup="false" Inherits="BIFConvenios.EditarCoordinadorCliente"
    CodeFile="EditarCoordinadorCliente.aspx.vb" EnableEventValidation="false" %>
...
<head>
    ...
    <script type="text/javascript">
			...
			function EliminarCoordinador(idCliente, idCoordinador, nomCoordinador) {
                    ...
                    <asp:UpdatePanel ID="upQuery" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="gvCoordinadores" runat="server" CellPadding="3" ForeColor="black"
                                ...
                                AllowSorting="true">
                                <Columns>
                                    <asp:BoundField DataField="iClienteId" HeaderText="Cliente" HeaderStyle-Width="80px" Visible="false" />
                                    <asp:BoundField DataField="iCoordinadorId" HeaderText="Codigo" HeaderStyle-Width="80px" />
                                    <asp:BoundField DataField="vNombreCoordinador" HeaderText="Coordinador" HeaderStyle-Width="150px" />
                                    <asp:BoundField DataField="vEmailCoordinador" HeaderText="Correo Electronico" HeaderStyle-Width="150px" />
                                    <asp:BoundField DataField="vCargo" HeaderText="Cargo" HeaderStyle-Width="150px" />
                                    <asp:BoundField DataField="vTipoPlanilla" HeaderText="Tipo Planilla" HeaderStyle-Width="150px" /> 
                                    ...
                                    <asp:TemplateField ItemStyle-Width="80px">
                                        <ItemTemplate>
                                            <a href='JavaScript:EliminarCoordinador("<%#Databinder.eval (Container.DataItem, "iClienteId") %>","<%#Databinder.Eval (Container.DataItem, "iCoordinadorId") %>","<%#Databinder.eval (Container.DataItem, "vNombreCoordinador") %>");'>Eliminar</a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
