...
#End Region
        ...
        Protected Function GetColor(Alert As String) As Color
        ...
        Private Function GetCheckedRegs() As String
            ...
            For i = 0 To dgProcesoResultErr.Items.Count - 1
                ...
                If chk.Checked Then
                    str &= dgProcesoResultErr.Items(i).Cells(2).Text + ","
                End If
            Next
            If str <> "" Then
        ...
        Private Sub lnkEnviaPrestamos_Click(sender As Object, e As EventArgs) Handles lnkEnviaPrestamos.Click
        ...
        Private Sub dgProcesoResultErr_PageIndexChanged(source As Object, e As DataGridPageChangedEventArgs) Handles dgProcesoResultErr.PageIndexChanged
        ...
        Private Sub dgProcesoResultVA_PageIndexChanged(source As Object, e As DataGridPageChangedEventArgs) Handles dgProcesoResultVA.PageIndexChanged
