...
Namespace BIFConvenios
    ...
    Partial Class ResultadoProcesoCronogramaFuturo
        Inherits Page
        ''Protected WithEvents ltrlNombre As Literal
        ''Protected WithEvents ltrlNombre1 As Literal
        ''Protected WithEvents ltrlAnhio As Literal
        ''Protected WithEvents ltrlMes As Literal
        ''Protected WithEvents ltrlFechaIBS As Literal
...
#End Region
        ...
        Private Sub lnkBack_Click(sender As Object, e As EventArgs) Handles lnkBack.Click
            ...
            If (strConsulta = 0) Then
                Response.Redirect(ResolveUrl("/cargageneracioncf.aspx"))
            Else
                Response.Redirect(ResolveUrl("/ReporteCronogramaFuturo.aspx"))
            End If
        End Sub
        ...
        Sub MostrarTotales()
            ...
            Dim strEstadoTrabajador As String = ddlEstadoTrabajador.SelectedValue.ToString()
            Dim strZonaUse As String = ddlZonaUse.SelectedValue.ToString()
            ...
            Try
                Dim _dtRegistroProcesos As DataTable = objProcesoBL.ObtieneRegistroResultadoProcesoPorFiltros(strCodigoProceso, strDocumento, strTrabajador, decPagare, strEstadoTrabajador, strZonaUse)
        ...
        Protected Sub dgProcesoResult_CancelCommand(source As Object, e As DataGridCommandEventArgs) Handles dgProcesoResult.CancelCommand
        ...
        Protected Sub dgProcesoResult_EditCommand(source As Object, e As DataGridCommandEventArgs) Handles dgProcesoResult.EditCommand
        ...
        Protected Sub dgProcesoResult_UpdateCommand(source As Object, e As DataGridCommandEventArgs) Handles dgProcesoResult.UpdateCommand
            ...
            If li_fila > 0 Then
                ...
                oproc.AddHistorico_ClienteCuota(Codigo_proceso, CodigoClienteIBS, Pagare, Trabajador, MyBase.Session("Importe"), Context.User.Identity.Name, MyBase.Session("CuotaPactada"), MyBase.Session("CuotaPagada"), MyBase.Session("lblCuotaPendiente"))
                dgProcesoResult.EditItemIndex = -1
        ...
        Protected Sub dgProcesoResult_ItemCommand(source As Object, e As DataGridCommandEventArgs) Handles dgProcesoResult.ItemCommand
        ...
        'Protected Sub lnkEnviarCorreo_Click(sender As Object, e As EventArgs) Handles lnkEnviarCorreo.Click
        ...
        Private Sub lnkGenerarArchivo_Click(sender As Object, e As EventArgs) Handles lnkGenerarArchivo.Click
            ...
            If hdId.Value IsNot Nothing And hdId.Value.Trim <> "" Then
                ...
                If formatoArchivo = "defaultXls" Then
                    Response.Redirect(ResolveUrl("/frmEnvioMail.aspx?id=" + strCodProceso + "&ibs=" + strCodIBS + "&consultar=" + strConsulta.ToString()))
                Else
                    'pnlGenArchivos.Visible = True
                    Response.Redirect(ResolveUrl("/generacionCf/EsperaFinalGeneracionCf.aspx?id=" + idGenFile + "&cantidad=" + lblTotalReg1.Text + "&montosoles=" + lblMontoTotalSoles1.Text + "&montodolares=" + lblMontoTotalDolares1.Text))
                End If
        ...
        Private Sub lnkObtenerReporte_Click(sender As Object, e As EventArgs) Handles lnkObtenerReporte.Click
        ...
        'Private Sub lnkEnviarMail_Click(sender As Object, e As EventArgs) Handles lnkEnviarMail.Click
        ...
        Public Sub OpenWindow(url As String)
        ...
        Private Sub ReloadPage()
            ...
            If dr.Read Then
                ...
                ltrlNombre1.Text = CType(dr("Nombre_Cliente"), String)
                ltrlAnhio1.Text = CType(dr("Anio_periodo"), String)
                ltrlMes1.Text = MonthName(dr("Mes_Periodo"))
                ltrlFechaIBS1.Text = Utils.GetFechaCanonica(CType(dr("Fecha_ProcesoAS400"), String))
                ShowGrid = CType(dr("ShowGrid"), Boolean)
        ...
        '******************************************************************************************************************************
        '****************************************************TI-EA2019-11648***********************************************************
        'Fecha Modificacion: 24/06/2019
        'Modificado Por: Magno Sanchez
        'Descripcion: Se agrego el redirect para la nueva pagina aspx ContainerListadoConsultaEnvioFinCierre
        '******************************************************************************************************************************
        Protected Sub RedirectReporte(codigo_proceso_ As String, modalidad As String, situacionTrabajador As String)
            Session.Add("Info", ArchivosDescuento.getDataSetListadoCuotasFinCierre(codigo_proceso_, modalidad, situacionTrabajador))
            ...
            Response.Redirect(getUrlPathApplicationRedirectPage("/consultas/ContainerListadoConsultaEnvioFinCierre.aspx?export=1"), True)
        End Sub
        '******************************************************************************************************************************
        ...
        Protected Sub LnkNuevo_Click(sender As Object, e As EventArgs) Handles LnkNuevo.Click
            'LimpiarTextbox()
            'MdlPupTrabajador.Show()
            Response.Redirect(getUrlPathApplicationRedirectPage("/RegistroCliente.aspx"), True)
        End Sub
